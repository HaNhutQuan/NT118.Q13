...
public class MainActivity extends AppCompatActivity {
    ...
    private void initVariables() {
        ...
        // send address to broadcastReceiver
        Intent intent = getIntent();
        if (intent != null && intent.hasExtra("sms_messages_key")) {
            ArrayList<String> addresses = intent.getStringArrayListExtra("sms_messages_key");
            processReceiveAddresses(addresses);
        }
